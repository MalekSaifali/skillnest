...
export default function FeedPage() {
  ...
  const loadFeed = async () => {
    try {
      ...
      const [meRes, postsRes] = await Promise.all([
        ...
        axios.get('https://d2wd5c91egufsr.cloudfront.net/api/posts', { headers }),
      ]);
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      const res = await axios.post('https://d2wd5c91egufsr.cloudfront.net/api/posts', { content }, { headers });
  ...
  const handleLike = async (postId: number) => {
    try {
      const headers = await getHeaders();
      const res = await axios.post(`https://d2wd5c91egufsr.cloudfront.net/api/posts/${postId}/like`, {}, { headers });
  ...
  const handleComment = async (postId: number) => {
    ...
    try {
      const headers = await getHeaders();
      const res = await axios.post(`https://d2wd5c91egufsr.cloudfront.net/api/posts/${postId}/comment`, { content: text }, { headers });
  ...
  const handleDelete = async (postId: number) => {
    try {
      const headers = await getHeaders();
      await axios.delete(`https://d2wd5c91egufsr.cloudfront.net/api/posts/${postId}`, { headers });
